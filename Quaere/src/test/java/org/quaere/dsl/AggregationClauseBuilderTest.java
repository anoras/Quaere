...
public class AggregationClauseBuilderTest {
    ...
    public void canApplyMinOperatorToArray() {
        ...
        AggregationClauseBuilder<Double> clauseBuilder = new AggregationClauseBuilderImpl<Double>("min",new Identifier("n"));
        Double min = clauseBuilder.by("").in(Double.class,numbers);
    ...
    public void canApplyMinOperatorWithLiteralQualifierExpression() {
        Integer[] numbers = {5, 4, 1, 3, 9, 8, 6, 7, 2};
        AggregationClauseBuilder<Double> clauseBuilder = new AggregationClauseBuilderImpl<Double>("min",new Identifier("n"));
        Double min = clauseBuilder.by("n + 1").in(Double.class,numbers);
    ...
    public void canApplyMaxOperatorToArray() {
        Integer[] numbers = {5, 4, 1, 3, 9, 8, 6, 7, 2};
        AggregationClauseBuilder<Double> clauseBuilder = new AggregationClauseBuilderImpl<Double>("max",new Identifier("n"));
        Double max = clauseBuilder.by("").in(Double.class,numbers);
    ...
    public void canApplyMaxOperatorWithLiteralQualifierExpression() {
        Integer[] numbers = {5, 4, 1, 3, 9, 8, 6, 7, 2};
        AggregationClauseBuilder<Double> clauseBuilder = new AggregationClauseBuilderImpl<Double>("max",new Identifier("n"));
        Double max = clauseBuilder.by("n + 1").in(Double.class,numbers);
    ...
    public void canApplyAverageOperatorToArray() {
        Integer[] numbers = {5, 4, 1, 3, 9, 8, 6, 7, 2};
        AggregationClauseBuilder<Double> clauseBuilder = new AggregationClauseBuilderImpl<Double>("average",new Identifier("n"));
        Double average = clauseBuilder.by("").in(Double.class,numbers);
    ...
    public void canApplyAverageOperatorWithLiteralQualifierExpression() {
        Integer[] numbers = {5, 4, 1, 3, 9, 8, 6, 7, 2};
        AggregationClauseBuilder<Double> clauseBuilder = new AggregationClauseBuilderImpl<Double>("average",new Identifier("n"));
        Double average = clauseBuilder.by("n + 1").in(Double.class,numbers);
    ...
    public void canApplyAverageOperatorWithQualifierExpression() {
        Integer[] numbers = {5, 4, 1, 3, 9, 8, 6, 7, 2};
        AggregationClauseBuilder<Double> clauseBuilder = new AggregationClauseBuilderImpl<Double>("average",new Identifier("n"));
        Double average = clauseBuilder.by(
                new PlusOperator(
                        new Statement(
                                Arrays.<Expression>asList(new Identifier("n"))
                        ),
