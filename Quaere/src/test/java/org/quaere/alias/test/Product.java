...
public class Product {
    ...
    public static List<Product> getProductList() {
        Product[] list = new Product[] { create(1, "Chai", "Beverages", 18, 39),
                create(2, "Chang", "Beverages", 19.0, 17), create(3, "Aniseed Syrup", "Condiments", 10.0, 13),
                ...
                create(13, "Konbu", "Seafood", 6.0, 24), create(14, "Tofu", "Produce", 23.2500, 35),
                create(15, "Genen Shouyu", "Condiments", 15.50, 39), create(16, "Pavlova", "Confections", 17.4500, 29),
                ...
                create(22, "Gustaf's Knäckebröd", "Grains/Cereals", 21.0, 104),
                create(23, "Tunnbröd", "Grains/Cereals", 9.0, 61),
                create(24, "Guaraná Fantástica", "Beverages", 4.50, 20),
                create(25, "NuNuCa Nuß-Nougat-Creme", "Confections", 14.0, 76),
                create(26, "Gumbär Gummibärchen", "Confections", 31.2300, 15),
                create(27, "Schoggi Schokolade", "Confections", 43.90, 49),
                create(28, "Rössle Sauerkraut", "Produce", 45.60, 26),
                create(29, "Thüringer Rostbratwurst", "Meat/Poultry", 123.7900, 0),
                ...
                create(35, "Steeleye Stout", "Beverages", 18.0, 20), create(36, "Inlagd Sill", "Seafood", 19.0, 112),
                create(37, "Gravad lax", "Seafood", 26.0, 11), create(38, "Côte de Blaye", "Beverages", 263.50, 17),
                ...
                create(44, "Gula Malacca", "Condiments", 19.4500, 27), create(45, "Rogede sild", "Seafood", 9.50, 5),
                create(46, "Spegesild", "Seafood", 12.0, 95), create(47, "Zaanse koeken", "Confections", 9.50, 36),
                create(48, "Chocolade", "Confections", 12.7500, 15), create(49, "Maxilaku", "Confections", 20.0, 10),
                ...
                create(54, "Tourtière", "Meat/Poultry", 7.4500, 21),
                create(55, "Pâté chinois", "Meat/Poultry", 24.0, 115),
                ...
                create(61, "Sirop d'érable", "Condiments", 28.50, 113),
                create(62, "Tarte au sucre", "Confections", 49.30, 17),
                create(63, "Vegie-spread", "Condiments", 43.90, 24),
                create(64, "Wimmers gute Semmelknödel", "Grains/Cereals", 33.2500, 22),
                ...
                create(73, "Röd Kaviar", "Seafood", 15.0, 101), create(74, "Longlife Tofu", "Produce", 10.0, 4),
                create(75, "Rhönbräu Klosterbier", "Beverages", 7.7500, 125),
                create(76, "Lakkalikööri", "Beverages", 18.0, 57),
                create(77, "Original Frankfurter grüne Soße", "Condiments", 13.0, 32) };
