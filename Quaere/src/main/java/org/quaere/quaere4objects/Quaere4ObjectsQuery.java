...
public class Quaere4ObjectsQuery implements ExpressionTreeVisitor, Query {
    ...
    public Quaere4ObjectsQuery(Expression query) {
        this.query = query;
    }
...
//                if (left.equals(right)) {
    ...
    public void visit(final OrderByClause expression) {
        final Quaere4ObjectsQuery thisRef = this;
    ...
    private Method findMethod(Class<? extends Object> clazz, String methodName, Class[] argumentClasses) throws NoSuchMethodException {
        try {
            Method method = clazz.getMethod(methodName, argumentClasses);
            return method;
        }
        catch (NoSuchMethodException e)
        {
...
//        }
    ...
    public void visit(Parameter expression) {
        throw new RuntimeException("Quaere4ObjectsQuery.visit is not implemented");
    }
...
// --------------------- Interface Query ---------------------
    ...
    public <T extends Object> void addSource(String identifier, List<T> source) {
        List<Object> s = new ArrayList<Object>();
        for (Object item : source) s.add(item);
        namedSources.put(identifier, s);
    }
